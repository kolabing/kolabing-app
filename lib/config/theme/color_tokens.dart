...
class KolabingColorTokens extends ThemeExtension<KolabingColorTokens> {
  const KolabingColorTokens({
    ...
    required this.categoryChipSportsBg,
    required this.categoryChipSportsText,
    required this.categoryChipFoodBg,
    required this.categoryChipFoodText,
    required this.categoryChipWellnessBg,
    required this.categoryChipWellnessText,
    required this.categoryChipCreativeBg,
    required this.categoryChipCreativeText,
    required this.categoryChipWomensBg,
    required this.categoryChipWomensText,
    required this.categoryChipBusinessBg,
    required this.categoryChipBusinessText,
    required this.categoryChipNeutralBg,
    required this.categoryChipNeutralText,
  ...
  final Color titleInk; // large display titles only
  ...
  // --- pastel category-taxonomy chip pairs (CategoryChip only) ---
  // Taxonomy cues ONLY. Never use for statuses, CTAs, match %, dates,
  // locations or other metadata. See CategoryStyleResolver.
  final Color categoryChipSportsBg;
  final Color categoryChipSportsText;
  final Color categoryChipFoodBg;
  final Color categoryChipFoodText;
  final Color categoryChipWellnessBg;
  final Color categoryChipWellnessText;
  final Color categoryChipCreativeBg;
  final Color categoryChipCreativeText;
  final Color categoryChipWomensBg;
  final Color categoryChipWomensText;
  final Color categoryChipBusinessBg;
  final Color categoryChipBusinessText;
  final Color categoryChipNeutralBg;
  final Color categoryChipNeutralText;
  ...
  static const KolabingColorTokens light = KolabingColorTokens(
    ...
    categoryChipSportsBg: Color(0xFFDDE9F7),
    categoryChipSportsText: Color(0xFF2C5578),
    categoryChipFoodBg: Color(0xFFFBE3DA),
    categoryChipFoodText: Color(0xFF8A462C),
    categoryChipWellnessBg: Color(0xFFE1EDDD),
    categoryChipWellnessText: Color(0xFF3F6438),
    categoryChipCreativeBg: Color(0xFFE7E0F5),
    categoryChipCreativeText: Color(0xFF534A73),
    categoryChipWomensBg: Color(0xFFF8DEE2),
    categoryChipWomensText: Color(0xFF8A3B4A),
    categoryChipBusinessBg: Color(0xFFF1E6D2),
    categoryChipBusinessText: Color(0xFF6E5628),
    categoryChipNeutralBg: Color(0xFFF2EEE6),
    categoryChipNeutralText: Color(0xFF5F5C54),
  ...
  static const KolabingColorTokens night = KolabingColorTokens(
    ...
    categoryChipSportsBg: Color(0xFF13293D),
    categoryChipSportsText: Color(0xFF9FC8EC),
    categoryChipFoodBg: Color(0xFF33201A),
    categoryChipFoodText: Color(0xFFF0B79F),
    categoryChipWellnessBg: Color(0xFF1E3320),
    categoryChipWellnessText: Color(0xFFA8D3A0),
    categoryChipCreativeBg: Color(0xFF272141),
    categoryChipCreativeText: Color(0xFFC6B8EE),
    categoryChipWomensBg: Color(0xFF39202A),
    categoryChipWomensText: Color(0xFFF0AFBC),
    categoryChipBusinessBg: Color(0xFF2C2617),
    categoryChipBusinessText: Color(0xFFD8C08A),
    categoryChipNeutralBg: Color(0xFF26262A),
    categoryChipNeutralText: Color(0xFFB9B6AE),
    overlayDark30: Color(0x4D000000),
    overlayDark50: Color(0x80000000),
  ...
  KolabingColorTokens copyWith({
    ...
    Color? categoryChipSportsBg,
    Color? categoryChipSportsText,
    Color? categoryChipFoodBg,
    Color? categoryChipFoodText,
    Color? categoryChipWellnessBg,
    Color? categoryChipWellnessText,
    Color? categoryChipCreativeBg,
    Color? categoryChipCreativeText,
    Color? categoryChipWomensBg,
    Color? categoryChipWomensText,
    Color? categoryChipBusinessBg,
    Color? categoryChipBusinessText,
    Color? categoryChipNeutralBg,
    Color? categoryChipNeutralText,
    Color? overlayDark30,
    Color? overlayDark50,
    Color? overlayDark60,
    Color? glassWhite14,
    ...
    categoryChipSportsBg: categoryChipSportsBg ?? this.categoryChipSportsBg,
    categoryChipSportsText:
        categoryChipSportsText ?? this.categoryChipSportsText,
    categoryChipFoodBg: categoryChipFoodBg ?? this.categoryChipFoodBg,
    categoryChipFoodText: categoryChipFoodText ?? this.categoryChipFoodText,
    categoryChipWellnessBg:
        categoryChipWellnessBg ?? this.categoryChipWellnessBg,
    categoryChipWellnessText:
        categoryChipWellnessText ?? this.categoryChipWellnessText,
    categoryChipCreativeBg:
        categoryChipCreativeBg ?? this.categoryChipCreativeBg,
    categoryChipCreativeText:
        categoryChipCreativeText ?? this.categoryChipCreativeText,
    categoryChipWomensBg: categoryChipWomensBg ?? this.categoryChipWomensBg,
    categoryChipWomensText:
        categoryChipWomensText ?? this.categoryChipWomensText,
    categoryChipBusinessBg:
        categoryChipBusinessBg ?? this.categoryChipBusinessBg,
    categoryChipBusinessText:
        categoryChipBusinessText ?? this.categoryChipBusinessText,
    categoryChipNeutralBg: categoryChipNeutralBg ?? this.categoryChipNeutralBg,
    categoryChipNeutralText:
        categoryChipNeutralText ?? this.categoryChipNeutralText,
  ...
  KolabingColorTokens lerp(KolabingColorTokens? other, double t) {
    ...
    return KolabingColorTokens(
      ...
      categoryChipSportsBg: Color.lerp(
        categoryChipSportsBg,
        other.categoryChipSportsBg,
        t,
      )!,
      categoryChipSportsText: Color.lerp(
        categoryChipSportsText,
        other.categoryChipSportsText,
        t,
      )!,
      categoryChipFoodBg: Color.lerp(
        categoryChipFoodBg,
        other.categoryChipFoodBg,
        t,
      )!,
      categoryChipFoodText: Color.lerp(
        categoryChipFoodText,
        other.categoryChipFoodText,
        t,
      )!,
      categoryChipWellnessBg: Color.lerp(
        categoryChipWellnessBg,
        other.categoryChipWellnessBg,
        t,
      )!,
      categoryChipWellnessText: Color.lerp(
        categoryChipWellnessText,
        other.categoryChipWellnessText,
        t,
      )!,
      categoryChipCreativeBg: Color.lerp(
        categoryChipCreativeBg,
        other.categoryChipCreativeBg,
        t,
      )!,
      categoryChipCreativeText: Color.lerp(
        categoryChipCreativeText,
        other.categoryChipCreativeText,
        t,
      )!,
      categoryChipWomensBg: Color.lerp(
        categoryChipWomensBg,
        other.categoryChipWomensBg,
        t,
      )!,
      categoryChipWomensText: Color.lerp(
        categoryChipWomensText,
        other.categoryChipWomensText,
        t,
      )!,
      categoryChipBusinessBg: Color.lerp(
        categoryChipBusinessBg,
        other.categoryChipBusinessBg,
        t,
      )!,
      categoryChipBusinessText: Color.lerp(
        categoryChipBusinessText,
        other.categoryChipBusinessText,
        t,
      )!,
      categoryChipNeutralBg: Color.lerp(
        categoryChipNeutralBg,
        other.categoryChipNeutralBg,
        t,
      )!,
      categoryChipNeutralText: Color.lerp(
        categoryChipNeutralText,
        other.categoryChipNeutralText,
        t,
      )!,
