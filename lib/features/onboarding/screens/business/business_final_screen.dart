...
class _BusinessFinalScreenState extends ConsumerState<BusinessFinalScreen> {
  ...
  Future<void> _handleRegister() async {
    ...
    final result =
        await ref.read(onboardingProvider.notifier).completeWithEmail(
    ...
    if (result.success) {
      ...
      if (!hasShownPermissions) {
        context.go('/permissions?destination=${Uri.encodeComponent('/business')}');
      } else {
        context.go('/business');
      }
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            border: OutlineInputBorder(
                              ...
                              borderSide:
                                  const BorderSide(color: KolabingColors.border),
                            ),
