...
class PublicChannelsRow extends StatelessWidget {
  const PublicChannelsRow({required this.channels, super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Wrap(
      ...
      children: [
        for (final channel in channels) _ChannelIconButton(channel: channel),
      ],
    );
  }
}
...
class _ChannelIconButton extends StatelessWidget {
  const _ChannelIconButton({required this.channel});
